...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-14 10:05 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-44559`**](https://nvd.nist.gov/vuln/detail/CVE-2026-44559) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.3**<br><sub>Open WebUI is a self-hosted artificial intelligence platform designed to operate entirely off...</sub><br><sub>Published: `2026-05-15`</sub> | [**GlendaleCommunityCollege**](https://www.google.com/search?q=GlendaleCommunityCollege%20data%20breach&tbm=nws) &nbsp; <sub>`glendale.edu`</sub><br><sub>**793,925** accounts compromised</sub><br><sub>Data: `academic records` `dates of birth` `email addresses` &nbsp;·&nbsp; Added: `2026-07-11`</sub> |
| [**`CVE-2026-44558`**](https://nvd.nist.gov/vuln/detail/CVE-2026-44558) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>Open WebUI is a self-hosted artificial intelligence platform designed to operate entirely off...</sub><br><sub>Published: `2026-05-15`</sub> | [**MoodyBibleInstitute**](https://www.google.com/search?q=MoodyBibleInstitute%20data%20breach&tbm=nws) &nbsp; <sub>`moody.edu`</sub><br><sub>**2,303,416** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-07-03`</sub> |
| [**`CVE-2026-44557`**](https://nvd.nist.gov/vuln/detail/CVE-2026-44557) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.3**<br><sub>Open WebUI is a self-hosted artificial intelligence platform designed to operate entirely off...</sub><br><sub>Published: `2026-05-15`</sub> | [**Sysco**](https://www.google.com/search?q=Sysco%20data%20breach&tbm=nws) &nbsp; <sub>`sysco.com`</sub><br><sub>**2,691,852** accounts compromised</sub><br><sub>Data: `customer feedback` `email addresses` `employers` &nbsp;·&nbsp; Added: `2026-06-28`</sub> |
<!-- SECURITY-END -->
---
