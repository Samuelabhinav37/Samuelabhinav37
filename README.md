...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-24 10:25 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-48850`**](https://nvd.nist.gov/vuln/detail/CVE-2026-48850) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.7**<br><sub>PuTTY 0.72 before 0.84 has a double free in RSA KEX.</sub><br><sub>Published: `2026-05-25`</sub> | [**Suno**](https://www.google.com/search?q=Suno%20data%20breach&tbm=nws) &nbsp; <sub>`suno.com`</sub><br><sub>**55,282,226** accounts compromised</sub><br><sub>Data: `email addresses` `names` `partial credit card data` &nbsp;·&nbsp; Added: `2026-07-20`</sub> |
| [**`CVE-2026-48589`**](https://nvd.nist.gov/vuln/detail/CVE-2026-48589) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>Apache Shiro’s Jakarta EE module used the HTTP Referer header in certain cases to issue redir...</sub><br><sub>Published: `2026-05-25`</sub> | [**Paidwork**](https://www.google.com/search?q=Paidwork%20data%20breach&tbm=nws) &nbsp; <sub>`paidwork.com`</sub><br><sub>**23,272,765** accounts compromised</sub><br><sub>Data: `bank account numbers` `dates of birth` `device information` &nbsp;·&nbsp; Added: `2026-07-19`</sub> |
| [**`CVE-2026-44598`**](https://nvd.nist.gov/vuln/detail/CVE-2026-44598) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>With valid login credentials, URL Redirection to Untrusted Site ('Open Redirect'), Server-Sid...</sub><br><sub>Published: `2026-05-25`</sub> | [**Fluke**](https://www.google.com/search?q=Fluke%20data%20breach&tbm=nws) &nbsp; <sub>`fluke.com`</sub><br><sub>**821,100** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
<!-- SECURITY-END -->
---
