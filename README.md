...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-15 10:08 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-8507`**](https://nvd.nist.gov/vuln/detail/CVE-2026-8507) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Crypt::OpenSSL::PKCS12 versions through 1.94 for Perl have out-of-bounds (OOB) write flaws.

...</sub><br><sub>Published: `2026-05-17`</sub> | [**Fluke**](https://www.google.com/search?q=Fluke%20data%20breach&tbm=nws) &nbsp; <sub>`fluke.com`</sub><br><sub>**821,100** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-46720`**](https://nvd.nist.gov/vuln/detail/CVE-2026-46720) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.2**<br><sub>Net::Statsd::Tiny versions before 0.3.8 for Perl allowed metric injections.

The metric names...</sub><br><sub>Published: `2026-05-17`</sub> | [**GooseCreek**](https://www.google.com/search?q=GooseCreek%20data%20breach&tbm=nws) &nbsp; <sub>`goosecreek.com`</sub><br><sub>**6,574,121** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-8759`**](https://nvd.nist.gov/vuln/detail/CVE-2026-8759) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.3**<br><sub>A vulnerability was identified in xiandafu beetl up to 3.20.2. Affected is an unknown functio...</sub><br><sub>Published: `2026-05-17`</sub> | [**GlendaleCommunityCollege**](https://www.google.com/search?q=GlendaleCommunityCollege%20data%20breach&tbm=nws) &nbsp; <sub>`glendale.edu`</sub><br><sub>**793,925** accounts compromised</sub><br><sub>Data: `academic records` `dates of birth` `email addresses` &nbsp;·&nbsp; Added: `2026-07-11`</sub> |
<!-- SECURITY-END -->
---
