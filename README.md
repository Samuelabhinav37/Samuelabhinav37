...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-09-01 13:23 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-58418`**](https://nvd.nist.gov/vuln/detail/CVE-2026-58418) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>SSRF via HTTP Redirect in Repository Migration</sub><br><sub>Published: `2026-07-03`</sub> | [**Questel**](https://www.google.com/search?q=Questel%20data%20breach&tbm=nws) &nbsp; <sub>`questel.com`</sub><br><sub>**1,226,209** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-09-01`</sub> |
| [**`CVE-2026-58300`**](https://nvd.nist.gov/vuln/detail/CVE-2026-58300) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.2**<br><sub>Absolute path traversal in Microsoft Edge for Android allows an unauthorized attacker to disc...</sub><br><sub>Published: `2026-07-03`</sub> | [**Carhartt**](https://www.google.com/search?q=Carhartt%20data%20breach&tbm=nws) &nbsp; <sub>`carhartt.com`</sub><br><sub>**12,933,413** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-25`</sub> |
| [**`CVE-2026-58299`**](https://nvd.nist.gov/vuln/detail/CVE-2026-58299) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>Time-of-check time-of-use (toctou) race condition in Microsoft Edge for Android allows an una...</sub><br><sub>Published: `2026-07-03`</sub> | [**NIUS**](https://www.google.com/search?q=NIUS%20data%20breach&tbm=nws) &nbsp; <sub>`nius.de`</sub><br><sub>**6,090** accounts compromised</sub><br><sub>Data: `bank account numbers` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-08-23`</sub> |
<!-- SECURITY-END -->
---
