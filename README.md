...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-10 11:12 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-42314`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42314) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>pyLoad is a free and open-source download manager written in Python. Prior to 0.5.0b3.dev100,...</sub><br><sub>Published: `2026-05-11`</sub> | [**MoodyBibleInstitute**](https://www.google.com/search?q=MoodyBibleInstitute%20data%20breach&tbm=nws) &nbsp; <sub>`moody.edu`</sub><br><sub>**2,303,416** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-07-03`</sub> |
| [**`CVE-2026-42313`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42313) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.3**<br><sub>pyLoad is a free and open-source download manager written in Python. Prior to 0.5.0b3.dev100,...</sub><br><sub>Published: `2026-05-11`</sub> | [**Sysco**](https://www.google.com/search?q=Sysco%20data%20breach&tbm=nws) &nbsp; <sub>`sysco.com`</sub><br><sub>**2,691,852** accounts compromised</sub><br><sub>Data: `customer feedback` `email addresses` `employers` &nbsp;·&nbsp; Added: `2026-06-28`</sub> |
| [**`CVE-2026-42312`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42312) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.8**<br><sub>pyLoad is a free and open-source download manager written in Python. Prior to 0.5.0b3.dev100,...</sub><br><sub>Published: `2026-05-11`</sub> | [**AmericanTower**](https://www.google.com/search?q=AmericanTower%20data%20breach&tbm=nws) &nbsp; <sub>`americantower.com`</sub><br><sub>**216,601** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-06-26`</sub> |
<!-- SECURITY-END -->
---
