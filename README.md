...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-12 11:49 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-6215`**](https://nvd.nist.gov/vuln/detail/CVE-2026-6215) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.3**<br><sub>A weakness has been identified in DbGate up to 7.1.4. The impacted element is the function ap...</sub><br><sub>Published: `2026-04-13`</sub> | [**UniversityOfNottingham**](https://www.google.com/search?q=UniversityOfNottingham%20data%20breach&tbm=nws) &nbsp; <sub>`nottingham.ac.uk`</sub><br><sub>**454,635** accounts compromised</sub><br><sub>Data: `academic records` `citizenship statuses` `dates of birth` &nbsp;·&nbsp; Added: `2026-06-10`</sub> |
| [**`CVE-2026-6202`**](https://nvd.nist.gov/vuln/detail/CVE-2026-6202) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.3**<br><sub>A security flaw has been discovered in code-projects Easy Blog Site 1.0. This affects an unkn...</sub><br><sub>Published: `2026-04-13`</sub> | [**BakerDistributing**](https://www.google.com/search?q=BakerDistributing%20data%20breach&tbm=nws) &nbsp; <sub>`bakerdist.com`</sub><br><sub>**102,935** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-06-07`</sub> |
| [**`CVE-2026-6201`**](https://nvd.nist.gov/vuln/detail/CVE-2026-6201) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>A vulnerability was identified in CodeAstro Online Job Portal 1.0. The impacted element is an...</sub><br><sub>Published: `2026-04-13`</sub> | [**BCDTravel**](https://www.google.com/search?q=BCDTravel%20data%20breach&tbm=nws) &nbsp; <sub>`bcdtravel.com`</sub><br><sub>**396,313** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-06-05`</sub> |
<!-- SECURITY-END -->
---
