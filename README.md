...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-26 08:51 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-57966`**](https://nvd.nist.gov/vuln/detail/CVE-2026-57966) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.4**<br><sub>A path traversal vulnerability was found in spice-vdagent. This flaw allows a malicious or co...</sub><br><sub>Published: `2026-06-29`</sub> | [**Carhartt**](https://www.google.com/search?q=Carhartt%20data%20breach&tbm=nws) &nbsp; <sub>`carhartt.com`</sub><br><sub>**12,933,413** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-25`</sub> |
| [**`CVE-2026-57965`**](https://nvd.nist.gov/vuln/detail/CVE-2026-57965) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.1**<br><sub>A flaw was found in spice-vdagent. A malicious or compromised SPICE host can trigger an integ...</sub><br><sub>Published: `2026-06-29`</sub> | [**NIUS**](https://www.google.com/search?q=NIUS%20data%20breach&tbm=nws) &nbsp; <sub>`nius.de`</sub><br><sub>**6,090** accounts compromised</sub><br><sub>Data: `bank account numbers` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-08-23`</sub> |
| [**`CVE-2026-57676`**](https://nvd.nist.gov/vuln/detail/CVE-2026-57676) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.3**<br><sub>Authorization Bypass Through User-Controlled Key vulnerability in Matteo Manna Simple User Av...</sub><br><sub>Published: `2026-06-29`</sub> | [**GolfCanada**](https://www.google.com/search?q=GolfCanada%20data%20breach&tbm=nws) &nbsp; <sub>`golfcanada.ca`</sub><br><sub>**568,972** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-08-22`</sub> |
<!-- SECURITY-END -->
---
