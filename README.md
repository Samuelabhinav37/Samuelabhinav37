...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-17 10:05 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-2611`**](https://nvd.nist.gov/vuln/detail/CVE-2026-2611) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.6**<br><sub>In MLflow version 3.9.0, the MLflow Assistant feature introduced improper origin validation i...</sub><br><sub>Published: `2026-05-19`</sub> | [**Fluke**](https://www.google.com/search?q=Fluke%20data%20breach&tbm=nws) &nbsp; <sub>`fluke.com`</sub><br><sub>**821,100** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-29226`**](https://nvd.nist.gov/vuln/detail/CVE-2026-29226) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.3**<br><sub>Server-Side Request Forgery (SSRF) vulnerability in Apache OFBiz via Content component operat...</sub><br><sub>Published: `2026-05-19`</sub> | [**GooseCreek**](https://www.google.com/search?q=GooseCreek%20data%20breach&tbm=nws) &nbsp; <sub>`goosecreek.com`</sub><br><sub>**6,574,121** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-29220`**](https://nvd.nist.gov/vuln/detail/CVE-2026-29220) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>Improper Limitation of a Pathname to a Restricted Directory ('Path Traversal') vulnerability ...</sub><br><sub>Published: `2026-05-19`</sub> | [**GlendaleCommunityCollege**](https://www.google.com/search?q=GlendaleCommunityCollege%20data%20breach&tbm=nws) &nbsp; <sub>`glendale.edu`</sub><br><sub>**793,925** accounts compromised</sub><br><sub>Data: `academic records` `dates of birth` `email addresses` &nbsp;·&nbsp; Added: `2026-07-11`</sub> |
<!-- SECURITY-END -->
---
