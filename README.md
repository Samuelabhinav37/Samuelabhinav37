...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-20 08:48 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-56424`**](https://nvd.nist.gov/vuln/detail/CVE-2026-56424) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>MISP core contained multiple broken access-control flaws where authorization checks were perf...</sub><br><sub>Published: `2026-06-22`</sub> | [**OzHairAndBeauty**](https://www.google.com/search?q=OzHairAndBeauty%20data%20breach&tbm=nws) &nbsp; <sub>`ozhairandbeauty.com`</sub><br><sub>**1,988,331** accounts compromised</sub><br><sub>Data: `email addresses` `geographic locations` `names` &nbsp;·&nbsp; Added: `2026-08-19`</sub> |
| [**`CVE-2026-56423`**](https://nvd.nist.gov/vuln/detail/CVE-2026-56423) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>MISP Core contained broken access-control checks in the bulk deletion flows for Event Reports...</sub><br><sub>Published: `2026-06-22`</sub> | [**Fanlore**](https://www.google.com/search?q=Fanlore%20data%20breach&tbm=nws) &nbsp; <sub>`fanlore.org`</sub><br><sub>**144,520** accounts compromised</sub><br><sub>Data: `email addresses` `names` `passwords` &nbsp;·&nbsp; Added: `2026-08-19`</sub> |
| [**`CVE-2026-54100`**](https://nvd.nist.gov/vuln/detail/CVE-2026-54100) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.3**<br><sub>A flaw was found in the Windows Machine Config Operator (WMCO) for Red Hat OpenShift Containe...</sub><br><sub>Published: `2026-06-22`</sub> | [**RingCentral**](https://www.google.com/search?q=RingCentral%20data%20breach&tbm=nws) &nbsp; <sub>`ringcentral.com`</sub><br><sub>**1,596,490** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-13`</sub> |
<!-- SECURITY-END -->
---
