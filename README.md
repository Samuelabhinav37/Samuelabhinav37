...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-27 11:32 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-45039`**](https://nvd.nist.gov/vuln/detail/CVE-2026-45039) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>RustFS is a distributed object storage system built in Rust. Prior to 1.0.0-beta.2, the inter...</sub><br><sub>Published: `2026-05-28`</sub> | [**Suno**](https://www.google.com/search?q=Suno%20data%20breach&tbm=nws) &nbsp; <sub>`suno.com`</sub><br><sub>**55,282,226** accounts compromised</sub><br><sub>Data: `email addresses` `names` `partial credit card data` &nbsp;·&nbsp; Added: `2026-07-20`</sub> |
| [**`CVE-2026-44394`**](https://nvd.nist.gov/vuln/detail/CVE-2026-44394) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.0**<br><sub>An issue was discovered in OpenStack Keystone before 29.0.2. The Keystone federated token res...</sub><br><sub>Published: `2026-05-28`</sub> | [**Paidwork**](https://www.google.com/search?q=Paidwork%20data%20breach&tbm=nws) &nbsp; <sub>`paidwork.com`</sub><br><sub>**23,272,765** accounts compromised</sub><br><sub>Data: `bank account numbers` `dates of birth` `device information` &nbsp;·&nbsp; Added: `2026-07-19`</sub> |
| [**`CVE-2026-43979`**](https://nvd.nist.gov/vuln/detail/CVE-2026-43979) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.0**<br><sub>Local Deep Research is an AI-powered research assistant for deep, iterative research. Prior t...</sub><br><sub>Published: `2026-05-28`</sub> | [**Fluke**](https://www.google.com/search?q=Fluke%20data%20breach&tbm=nws) &nbsp; <sub>`fluke.com`</sub><br><sub>**821,100** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
<!-- SECURITY-END -->
---
