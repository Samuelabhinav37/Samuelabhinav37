...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-09-21 15:00 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-63732`**](https://nvd.nist.gov/vuln/detail/CVE-2026-63732) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.9**<br><sub>9router 0.4.59 (fixed in 0.4.60) contains a chain of vulnerabilities: a hardcoded default pas...</sub><br><sub>Published: `2026-07-23`</sub> | [**BurgerKingRussia**](https://www.google.com/search?q=BurgerKingRussia%20data%20breach&tbm=nws) &nbsp; <sub>`burgerkingrus.ru`</sub><br><sub>**3,155,792** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-09-21`</sub> |
| [**`CVE-2026-63313`**](https://nvd.nist.gov/vuln/detail/CVE-2026-63313) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.7**<br><sub>9Router before 0.4.72 contains a server-side request forgery (SSRF) vulnerability in the /v1/...</sub><br><sub>Published: `2026-07-23`</sub> | [**Chess2026**](https://www.google.com/search?q=Chess2026%20data%20breach&tbm=nws) &nbsp; <sub>`chess.com`</sub><br><sub>**4,653,212** accounts compromised</sub><br><sub>Data: `email addresses` `geographic locations` `names` &nbsp;·&nbsp; Added: `2026-09-13`</sub> |
| [**`CVE-2026-16807`**](https://nvd.nist.gov/vuln/detail/CVE-2026-16807) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>Out of bounds write in Codecs in Google Chrome prior to 150.0.7871.186 allowed a remote attac...</sub><br><sub>Published: `2026-07-23`</sub> | [**McKesson**](https://www.google.com/search?q=McKesson%20data%20breach&tbm=nws) &nbsp; <sub>`mckesson.com`</sub><br><sub>**6,404,340** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `employers` &nbsp;·&nbsp; Added: `2026-09-10`</sub> |
<!-- SECURITY-END -->
---
