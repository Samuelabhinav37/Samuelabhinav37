...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-13 09:18 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-20262`**](https://nvd.nist.gov/vuln/detail/CVE-2026-20262) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>A vulnerability in the web UI of Cisco Catalyst SD-WAN Manager, formerly SD-WAN vManage, coul...</sub><br><sub>Published: `2026-06-15`</sub> | [**Alcon**](https://www.google.com/search?q=Alcon%20data%20breach&tbm=nws) &nbsp; <sub>`alcon.com`</sub><br><sub>**218,395** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-09`</sub> |
| [**`CVE-2026-9863`**](https://nvd.nist.gov/vuln/detail/CVE-2026-9863) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>Fortra BoKS Manager contains an OS command injection vulnerability in the client upgrade and ...</sub><br><sub>Published: `2026-06-15`</sub> | [**BrinksHome**](https://www.google.com/search?q=BrinksHome%20data%20breach&tbm=nws) &nbsp; <sub>`brinkshome.com`</sub><br><sub>**732,162** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-08-08`</sub> |
| [**`CVE-2026-9862`**](https://nvd.nist.gov/vuln/detail/CVE-2026-9862) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Fortra's 
Core Privileged Access Manager (BoKS) contains an OS command injection vulnerabilit...</sub><br><sub>Published: `2026-06-15`</sub> | [**ExactSciences**](https://www.google.com/search?q=ExactSciences%20data%20breach&tbm=nws) &nbsp; <sub>`exactsciences.com`</sub><br><sub>**10,869,543** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-08-07`</sub> |
<!-- SECURITY-END -->
---
