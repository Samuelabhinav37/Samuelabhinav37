...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-26 10:56 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-5362`**](https://nvd.nist.gov/vuln/detail/CVE-2026-5362) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.4**<br><sub>An authenticated attacker with permission to edit document content can store crafted HTML/Jav...</sub><br><sub>Published: `2026-04-27`</sub> | [**AmericanTower**](https://www.google.com/search?q=AmericanTower%20data%20breach&tbm=nws) &nbsp; <sub>`americantower.com`</sub><br><sub>**216,601** accounts compromised</sub><br><sub>Data: `email addresses` `job titles` `names` &nbsp;·&nbsp; Added: `2026-06-26`</sub> |
| [**`CVE-2026-3087`**](https://nvd.nist.gov/vuln/detail/CVE-2026-3087) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>If `shutil.unpack_archive()` is given a ZIP archive with an absolute Windows path containing ...</sub><br><sub>Published: `2026-04-27`</sub> | [**MadisonSquareGardenSports**](https://www.google.com/search?q=MadisonSquareGardenSports%20data%20breach&tbm=nws) &nbsp; <sub>`msgsports.com`</sub><br><sub>**9,796,738** accounts compromised</sub><br><sub>Data: `customer service records` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-06-24`</sub> |
| [**`CVE-2026-29971`**](https://nvd.nist.gov/vuln/detail/CVE-2026-29971) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.1**<br><sub>A reflected cross-site scripting (XSS) vulnerability exists in WebFileSys version before 2.32...</sub><br><sub>Published: `2026-04-27`</sub> | [**JCPenney**](https://www.google.com/search?q=JCPenney%20data%20breach&tbm=nws) &nbsp; <sub>`jcpenny.com`</sub><br><sub>**368,418** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `government issued ids` &nbsp;·&nbsp; Added: `2026-06-20`</sub> |
<!-- SECURITY-END -->
---
