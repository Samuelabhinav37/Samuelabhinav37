...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-17 08:51 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-32174`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32174) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.7**<br><sub>Improper authentication in Azure Bot Service allows an authorized attacker to elevate privile...</sub><br><sub>Published: `2026-06-18`</sub> | [**RingCentral**](https://www.google.com/search?q=RingCentral%20data%20breach&tbm=nws) &nbsp; <sub>`ringcentral.com`</sub><br><sub>**1,596,490** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-13`</sub> |
| [**`CVE-2026-22674`**](https://nvd.nist.gov/vuln/detail/CVE-2026-22674) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.8**<br><sub>Hashgraph Guardian through 3.6.0, fixed in commit ba8c566, contains a stored cross-site scrip...</sub><br><sub>Published: `2026-06-18`</sub> | [**Alcon**](https://www.google.com/search?q=Alcon%20data%20breach&tbm=nws) &nbsp; <sub>`alcon.com`</sub><br><sub>**218,395** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-09`</sub> |
| [**`CVE-2026-49454`**](https://nvd.nist.gov/vuln/detail/CVE-2026-49454) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.1**<br><sub>Relyra is a strict-by-default SAML 2.0 Service Provider library for Elixir and Phoenix. Versi...</sub><br><sub>Published: `2026-06-18`</sub> | [**BrinksHome**](https://www.google.com/search?q=BrinksHome%20data%20breach&tbm=nws) &nbsp; <sub>`brinkshome.com`</sub><br><sub>**732,162** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-08-08`</sub> |
<!-- SECURITY-END -->
---
