...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-14 09:12 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-38812`**](https://nvd.nist.gov/vuln/detail/CVE-2026-38812) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>RuoYi v4.8.2 is vulnerable to SQL Injection via the /tool/gen/createTable endpoint. The issue...</sub><br><sub>Published: `2026-06-15`</sub> | [**RingCentral**](https://www.google.com/search?q=RingCentral%20data%20breach&tbm=nws) &nbsp; <sub>`ringcentral.com`</sub><br><sub>**1,596,490** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-13`</sub> |
| [**`CVE-2026-38329`**](https://nvd.nist.gov/vuln/detail/CVE-2026-38329) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Bludit CMS before version 3.18.4 allows Remote Code Execution (RCE) via the API Plugin. The P...</sub><br><sub>Published: `2026-06-15`</sub> | [**Alcon**](https://www.google.com/search?q=Alcon%20data%20breach&tbm=nws) &nbsp; <sub>`alcon.com`</sub><br><sub>**218,395** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-09`</sub> |
| [**`CVE-2026-38065`**](https://nvd.nist.gov/vuln/detail/CVE-2026-38065) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Tenda 5G03 V05.03.02.04 (Version 1.0) is vulnerable to Command injection in the function acti...</sub><br><sub>Published: `2026-06-15`</sub> | [**BrinksHome**](https://www.google.com/search?q=BrinksHome%20data%20breach&tbm=nws) &nbsp; <sub>`brinkshome.com`</sub><br><sub>**732,162** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-08-08`</sub> |
<!-- SECURITY-END -->
---
