...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-09-07 14:09 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-0286`**](https://nvd.nist.gov/vuln/detail/CVE-2026-0286) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.2**<br><sub>A command injection vulnerability in the management plane of Palo Alto Networks PAN-OS® softw...</sub><br><sub>Published: `2026-07-09`</sub> | [**ManchesterAirportsGroup**](https://www.google.com/search?q=ManchesterAirportsGroup%20data%20breach&tbm=nws) &nbsp; <sub>`magairports.com`</sub><br><sub>**8,849,657** accounts compromised</sub><br><sub>Data: `browser user agent details` `email addresses` `geographic locations` &nbsp;·&nbsp; Added: `2026-09-02`</sub> |
| [**`CVE-2026-0285`**](https://nvd.nist.gov/vuln/detail/CVE-2026-0285) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.9**<br><sub>A server-side request forgery (SSRF) vulnerability in Palo Alto Networks PAN-OS software enab...</sub><br><sub>Published: `2026-07-09`</sub> | [**Questel**](https://www.google.com/search?q=Questel%20data%20breach&tbm=nws) &nbsp; <sub>`questel.com`</sub><br><sub>**1,226,209** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-09-01`</sub> |
| [**`CVE-2026-0284`**](https://nvd.nist.gov/vuln/detail/CVE-2026-0284) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.9**<br><sub>An XML injection vulnerability in the Large Scale VPN (LSVPN) functionality of Palo Alto Netw...</sub><br><sub>Published: `2026-07-09`</sub> | [**Carhartt**](https://www.google.com/search?q=Carhartt%20data%20breach&tbm=nws) &nbsp; <sub>`carhartt.com`</sub><br><sub>**12,933,413** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-25`</sub> |
<!-- SECURITY-END -->
---
