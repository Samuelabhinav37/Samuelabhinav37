...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-06 10:12 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-32588`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32588) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>Authenticated DoS over CQL in Apache Cassandra 4.0, 4.1, 5.0 allows authenticated user to rai...</sub><br><sub>Published: `2026-04-07`</sub> | [**BCDTravel**](https://www.google.com/search?q=BCDTravel%20data%20breach&tbm=nws) &nbsp; <sub>`bcdtravel.com`</sub><br><sub>**396,313** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-06-05`</sub> |
| [**`CVE-2026-27315`**](https://nvd.nist.gov/vuln/detail/CVE-2026-27315) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.5**<br><sub>Sensitive Information Leak in cqlsh in Apache Cassandra 4.0 allows access to sensitive inform...</sub><br><sub>Published: `2026-04-07`</sub> | [**DentaQuest**](https://www.google.com/search?q=DentaQuest%20data%20breach&tbm=nws) &nbsp; <sub>`dentaquest.com`</sub><br><sub>**2,553,599** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-06-03`</sub> |
| [**`CVE-2026-27314`**](https://nvd.nist.gov/vuln/detail/CVE-2026-27314) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>Privilege escalation in Apache Cassandra 5.0 on an mTLS environment using MutualTlsAuthentica...</sub><br><sub>Published: `2026-04-07`</sub> | [**Edmunds**](https://www.google.com/search?q=Edmunds%20data%20breach&tbm=nws) &nbsp; <sub>`edmunds.com`</sub><br><sub>**177,860** accounts compromised</sub><br><sub>Data: `device information` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-06-01`</sub> |
<!-- SECURITY-END -->
---
