...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-13 10:34 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-23653`**](https://nvd.nist.gov/vuln/detail/CVE-2026-23653) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.7**<br><sub>Improper neutralization of special elements used in a command ('command injection') in GitHub...</sub><br><sub>Published: `2026-04-14`</sub> | [**UniversityOfNottingham**](https://www.google.com/search?q=UniversityOfNottingham%20data%20breach&tbm=nws) &nbsp; <sub>`nottingham.ac.uk`</sub><br><sub>**454,635** accounts compromised</sub><br><sub>Data: `academic records` `citizenship statuses` `dates of birth` &nbsp;·&nbsp; Added: `2026-06-10`</sub> |
| [**`CVE-2026-21331`**](https://nvd.nist.gov/vuln/detail/CVE-2026-21331) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.1**<br><sub>Adobe Connect versions 2025.3, 12.10 and earlier are affected by a reflected Cross-Site Scrip...</sub><br><sub>Published: `2026-04-14`</sub> | [**BakerDistributing**](https://www.google.com/search?q=BakerDistributing%20data%20breach&tbm=nws) &nbsp; <sub>`bakerdist.com`</sub><br><sub>**102,935** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-06-07`</sub> |
| [**`CVE-2026-20945`**](https://nvd.nist.gov/vuln/detail/CVE-2026-20945) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.6**<br><sub>Improper neutralization of input during web page generation ('cross-site scripting') in Micro...</sub><br><sub>Published: `2026-04-14`</sub> | [**BCDTravel**](https://www.google.com/search?q=BCDTravel%20data%20breach&tbm=nws) &nbsp; <sub>`bcdtravel.com`</sub><br><sub>**396,313** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-06-05`</sub> |
<!-- SECURITY-END -->
---
