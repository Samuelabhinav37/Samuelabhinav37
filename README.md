...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-09-14 14:55 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-49998`**](https://nvd.nist.gov/vuln/detail/CVE-2026-49998) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.2**<br><sub>Centrifugo is an open-source scalable real-time messaging server. Prior to 6.8.1, Centrifugo ...</sub><br><sub>Published: `2026-07-16`</sub> | [**Chess2026**](https://www.google.com/search?q=Chess2026%20data%20breach&tbm=nws) &nbsp; <sub>`chess.com`</sub><br><sub>**4,653,212** accounts compromised</sub><br><sub>Data: `email addresses` `geographic locations` `names` &nbsp;·&nbsp; Added: `2026-09-13`</sub> |
| [**`CVE-2026-44982`**](https://nvd.nist.gov/vuln/detail/CVE-2026-44982) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.2**<br><sub>CrowdSec offers crowdsourced protection against malicious IPs. From 1.5.0 until 1.7.8, pkg/ap...</sub><br><sub>Published: `2026-07-16`</sub> | [**McKesson**](https://www.google.com/search?q=McKesson%20data%20breach&tbm=nws) &nbsp; <sub>`mckesson.com`</sub><br><sub>**6,404,340** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `employers` &nbsp;·&nbsp; Added: `2026-09-10`</sub> |
| [**`CVE-2026-15352`**](https://nvd.nist.gov/vuln/detail/CVE-2026-15352) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>A vulnerability exists in the Health & Safety (HS) application of NASA's Core Flight System (...</sub><br><sub>Published: `2026-07-16`</sub> | [**ManchesterAirportsGroup**](https://www.google.com/search?q=ManchesterAirportsGroup%20data%20breach&tbm=nws) &nbsp; <sub>`magairports.com`</sub><br><sub>**8,849,657** accounts compromised</sub><br><sub>Data: `browser user agent details` `email addresses` `geographic locations` &nbsp;·&nbsp; Added: `2026-09-02`</sub> |
<!-- SECURITY-END -->
---
