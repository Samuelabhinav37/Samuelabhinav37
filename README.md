...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-08 08:50 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-8045`**](https://nvd.nist.gov/vuln/detail/CVE-2026-8045) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.5**<br><sub>CWE-611 Improper Restriction of XML External Entity Reference vulnerability exists that could...</sub><br><sub>Published: `2026-06-09`</sub> | [**ExactSciences**](https://www.google.com/search?q=ExactSciences%20data%20breach&tbm=nws) &nbsp; <sub>`exactsciences.com`</sub><br><sub>**10,869,543** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-08-07`</sub> |
| [**`CVE-2026-8025`**](https://nvd.nist.gov/vuln/detail/CVE-2026-8025) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Improper neutralization of special elements used in an SQL command ('SQL injection') vulnerab...</sub><br><sub>Published: `2026-06-09`</sub> | [**InterConSecurity**](https://www.google.com/search?q=InterConSecurity%20data%20breach&tbm=nws) &nbsp; <sub>`icsecurity.com`</sub><br><sub>**276,114** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-08-05`</sub> |
| [**`CVE-2026-49948`**](https://nvd.nist.gov/vuln/detail/CVE-2026-49948) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.1**<br><sub>Mem0 versions through 0.2.8, fixed in commit ae7f406, contain a missing authorization vulnera...</sub><br><sub>Published: `2026-06-09`</sub> | [**SplitVPN**](https://www.google.com/search?q=SplitVPN%20data%20breach&tbm=nws) &nbsp; <sub>`splitvpn.io`</sub><br><sub>**865,336** accounts compromised</sub><br><sub>Data: `device information` `email addresses` `geographic locations` &nbsp;·&nbsp; Added: `2026-08-01`</sub> |
<!-- SECURITY-END -->
---
