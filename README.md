...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-08 12:39 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-32990`**](https://nvd.nist.gov/vuln/detail/CVE-2026-32990) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.3**<br><sub>Improper Input Validation vulnerability in Apache Tomcat due to an incomplete fix of CVE-2025...</sub><br><sub>Published: `2026-04-09`</sub> | [**BakerDistributing**](https://www.google.com/search?q=BakerDistributing%20data%20breach&tbm=nws) &nbsp; <sub>`bakerdist.com`</sub><br><sub>**102,935** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-06-07`</sub> |
| [**`CVE-2026-29923`**](https://nvd.nist.gov/vuln/detail/CVE-2026-29923) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.8**<br><sub>The pstrip64.sys driver in EnTech Taiwan PowerStrip <=3.90.736 allows local users to escalate...</sub><br><sub>Published: `2026-04-09`</sub> | [**BCDTravel**](https://www.google.com/search?q=BCDTravel%20data%20breach&tbm=nws) &nbsp; <sub>`bcdtravel.com`</sub><br><sub>**396,313** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-06-05`</sub> |
| [**`CVE-2026-29146`**](https://nvd.nist.gov/vuln/detail/CVE-2026-29146) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>Padding Oracle vulnerability in Apache Tomcat's EncryptInterceptor with default configuration...</sub><br><sub>Published: `2026-04-09`</sub> | [**DentaQuest**](https://www.google.com/search?q=DentaQuest%20data%20breach&tbm=nws) &nbsp; <sub>`dentaquest.com`</sub><br><sub>**2,553,599** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-06-03`</sub> |
<!-- SECURITY-END -->
---
