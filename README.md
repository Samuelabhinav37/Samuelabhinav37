...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-09-02 12:41 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-14759`**](https://nvd.nist.gov/vuln/detail/CVE-2026-14759) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.3**<br><sub>A security flaw has been discovered in radareorg radare2 up to 6.1.6. This issue affects the ...</sub><br><sub>Published: `2026-07-05`</sub> | [**ManchesterAirportsGroup**](https://www.google.com/search?q=ManchesterAirportsGroup%20data%20breach&tbm=nws) &nbsp; <sub>`magairports.com`</sub><br><sub>**8,728,451** accounts compromised</sub><br><sub>Data: `browser user agent details` `email addresses` `geographic locations` &nbsp;·&nbsp; Added: `2026-09-02`</sub> |
| [**`CVE-2026-9085`**](https://nvd.nist.gov/vuln/detail/CVE-2026-9085) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>Incorrect Permission Assignment for Critical Resource, Improper Access Control vulnerability ...</sub><br><sub>Published: `2026-07-05`</sub> | [**Questel**](https://www.google.com/search?q=Questel%20data%20breach&tbm=nws) &nbsp; <sub>`questel.com`</sub><br><sub>**1,226,209** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-09-01`</sub> |
| [**`CVE-2026-6509`**](https://nvd.nist.gov/vuln/detail/CVE-2026-6509) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.8**<br><sub>Missing Authorization vulnerability in TUBITAK BILGEM Software Technologies Research Institut...</sub><br><sub>Published: `2026-07-05`</sub> | [**Carhartt**](https://www.google.com/search?q=Carhartt%20data%20breach&tbm=nws) &nbsp; <sub>`carhartt.com`</sub><br><sub>**12,933,413** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-25`</sub> |
<!-- SECURITY-END -->
---
