...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-11 12:15 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-34866`**](https://nvd.nist.gov/vuln/detail/CVE-2026-34866) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.1**<br><sub>Out-of-bounds write vulnerability in the WEB module.Impact: Successful exploitation of this v...</sub><br><sub>Published: `2026-04-13`</sub> | [**UniversityOfNottingham**](https://www.google.com/search?q=UniversityOfNottingham%20data%20breach&tbm=nws) &nbsp; <sub>`nottingham.ac.uk`</sub><br><sub>**454,635** accounts compromised</sub><br><sub>Data: `academic records` `citizenship statuses` `dates of birth` &nbsp;·&nbsp; Added: `2026-06-10`</sub> |
| [**`CVE-2026-34865`**](https://nvd.nist.gov/vuln/detail/CVE-2026-34865) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.1**<br><sub>Out-of-bounds write vulnerability in the WEB module.Impact: Successful exploitation of this v...</sub><br><sub>Published: `2026-04-13`</sub> | [**BakerDistributing**](https://www.google.com/search?q=BakerDistributing%20data%20breach&tbm=nws) &nbsp; <sub>`bakerdist.com`</sub><br><sub>**102,935** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-06-07`</sub> |
| [**`CVE-2025-15441`**](https://nvd.nist.gov/vuln/detail/CVE-2025-15441) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.8**<br><sub>The Form Maker by 10Web  WordPress plugin before 1.15.38 does not properly prepare SQL querie...</sub><br><sub>Published: `2026-04-13`</sub> | [**BCDTravel**](https://www.google.com/search?q=BCDTravel%20data%20breach&tbm=nws) &nbsp; <sub>`bcdtravel.com`</sub><br><sub>**396,313** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-06-05`</sub> |
<!-- SECURITY-END -->
---
