...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-14 10:52 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-40918`**](https://nvd.nist.gov/vuln/detail/CVE-2026-40918) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.5**<br><sub>A flaw was found in GIMP. Processing a specially crafted PVR image file with large dimensions...</sub><br><sub>Published: `2026-04-15`</sub> | [**UniversityOfNottingham**](https://www.google.com/search?q=UniversityOfNottingham%20data%20breach&tbm=nws) &nbsp; <sub>`nottingham.ac.uk`</sub><br><sub>**454,635** accounts compromised</sub><br><sub>Data: `academic records` `citizenship statuses` `dates of birth` &nbsp;·&nbsp; Added: `2026-06-10`</sub> |
| [**`CVE-2026-40917`**](https://nvd.nist.gov/vuln/detail/CVE-2026-40917) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.0**<br><sub>A flaw was found in GIMP. This vulnerability, a heap buffer over-read in the `icns_slurp()` f...</sub><br><sub>Published: `2026-04-15`</sub> | [**BakerDistributing**](https://www.google.com/search?q=BakerDistributing%20data%20breach&tbm=nws) &nbsp; <sub>`bakerdist.com`</sub><br><sub>**102,935** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-06-07`</sub> |
| [**`CVE-2026-40916`**](https://nvd.nist.gov/vuln/detail/CVE-2026-40916) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **5.0**<br><sub>A flaw was found in GIMP. A stack buffer overflow vulnerability in the TIM image loader's 4BP...</sub><br><sub>Published: `2026-04-15`</sub> | [**BCDTravel**](https://www.google.com/search?q=BCDTravel%20data%20breach&tbm=nws) &nbsp; <sub>`bcdtravel.com`</sub><br><sub>**396,313** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-06-05`</sub> |
<!-- SECURITY-END -->
---
