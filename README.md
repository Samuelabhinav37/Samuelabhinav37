...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-09-09 12:52 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-15526`**](https://nvd.nist.gov/vuln/detail/CVE-2026-15526) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.3**<br><sub>A flaw has been found in augmnt augments-mcp-server 7.1.0. This issue affects the function sc...</sub><br><sub>Published: `2026-07-13`</sub> | [**ManchesterAirportsGroup**](https://www.google.com/search?q=ManchesterAirportsGroup%20data%20breach&tbm=nws) &nbsp; <sub>`magairports.com`</sub><br><sub>**8,849,657** accounts compromised</sub><br><sub>Data: `browser user agent details` `email addresses` `geographic locations` &nbsp;·&nbsp; Added: `2026-09-02`</sub> |
| [**`CVE-2026-15525`**](https://nvd.nist.gov/vuln/detail/CVE-2026-15525) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.3**<br><sub>A vulnerability was detected in kLOsk adloop up to 0.9.0. This vulnerability affects the func...</sub><br><sub>Published: `2026-07-13`</sub> | [**Questel**](https://www.google.com/search?q=Questel%20data%20breach&tbm=nws) &nbsp; <sub>`questel.com`</sub><br><sub>**1,226,209** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-09-01`</sub> |
| [**`CVE-2026-15524`**](https://nvd.nist.gov/vuln/detail/CVE-2026-15524) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.3**<br><sub>A security vulnerability has been detected in alioshr memory-bank-mcp up to 0.2.1/3.1. This a...</sub><br><sub>Published: `2026-07-13`</sub> | [**Carhartt**](https://www.google.com/search?q=Carhartt%20data%20breach&tbm=nws) &nbsp; <sub>`carhartt.com`</sub><br><sub>**12,933,413** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-25`</sub> |
<!-- SECURITY-END -->
---
