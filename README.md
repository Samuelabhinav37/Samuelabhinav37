...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-18 09:39 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-30117`**](https://nvd.nist.gov/vuln/detail/CVE-2026-30117) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>scalar/astro v0.1.13 was discovered to contain an arbitrary file upload vulnerability in the ...</sub><br><sub>Published: `2026-05-19`</sub> | [**Fluke**](https://www.google.com/search?q=Fluke%20data%20breach&tbm=nws) &nbsp; <sub>`fluke.com`</sub><br><sub>**821,100** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-8711`**](https://nvd.nist.gov/vuln/detail/CVE-2026-8711) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.1**<br><sub>NGINX JavaScript has a vulnerability when the js_fetch_proxy directive is configured with at ...</sub><br><sub>Published: `2026-05-19`</sub> | [**GooseCreek**](https://www.google.com/search?q=GooseCreek%20data%20breach&tbm=nws) &nbsp; <sub>`goosecreek.com`</sub><br><sub>**6,574,121** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-47100`**](https://nvd.nist.gov/vuln/detail/CVE-2026-47100) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>Funnel Builder for WooCommerce Checkout prior to 3.15.0.3 contains a missing authorization vu...</sub><br><sub>Published: `2026-05-19`</sub> | [**GlendaleCommunityCollege**](https://www.google.com/search?q=GlendaleCommunityCollege%20data%20breach&tbm=nws) &nbsp; <sub>`glendale.edu`</sub><br><sub>**793,925** accounts compromised</sub><br><sub>Data: `academic records` `dates of birth` `email addresses` &nbsp;·&nbsp; Added: `2026-07-11`</sub> |
<!-- SECURITY-END -->
---
