...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-07 09:06 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-11531`**](https://nvd.nist.gov/vuln/detail/CVE-2026-11531) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.3**<br><sub>A security flaw has been discovered in imvks786 student_management_system up to 9599b560ad3c3...</sub><br><sub>Published: `2026-06-08`</sub> | [**ExactSciences**](https://www.google.com/search?q=ExactSciences%20data%20breach&tbm=nws) &nbsp; <sub>`exactsciences.com`</sub><br><sub>**10,869,543** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-08-07`</sub> |
| [**`CVE-2026-11530`**](https://nvd.nist.gov/vuln/detail/CVE-2026-11530) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.3**<br><sub>A vulnerability was identified in imvks786 student_management_system up to 9599b560ad3c3b83e7...</sub><br><sub>Published: `2026-06-08`</sub> | [**InterConSecurity**](https://www.google.com/search?q=InterConSecurity%20data%20breach&tbm=nws) &nbsp; <sub>`icsecurity.com`</sub><br><sub>**276,114** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-08-05`</sub> |
| [**`CVE-2026-49975`**](https://nvd.nist.gov/vuln/detail/CVE-2026-49975) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>Memory Allocation with Excessive Size Value vulnerability in Apache HTTP Server's mod_http le...</sub><br><sub>Published: `2026-06-08`</sub> | [**SplitVPN**](https://www.google.com/search?q=SplitVPN%20data%20breach&tbm=nws) &nbsp; <sub>`splitvpn.io`</sub><br><sub>**865,336** accounts compromised</sub><br><sub>Data: `device information` `email addresses` `geographic locations` &nbsp;·&nbsp; Added: `2026-08-01`</sub> |
<!-- SECURITY-END -->
---
