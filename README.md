...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-31 16:03 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-12064`**](https://nvd.nist.gov/vuln/detail/CVE-2026-12064) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>When a user invokes curl using a schemeless URL combined with
`--proto-default` sftp (or scp)...</sub><br><sub>Published: `2026-07-03`</sub> | [**Carhartt**](https://www.google.com/search?q=Carhartt%20data%20breach&tbm=nws) &nbsp; <sub>`carhartt.com`</sub><br><sub>**12,933,413** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-25`</sub> |
| [**`CVE-2026-11856`**](https://nvd.nist.gov/vuln/detail/CVE-2026-11856) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.8**<br><sub>Successfully using libcurl to do a transfer to a specific HTTP origin
(`hostA`) with **Digest...</sub><br><sub>Published: `2026-07-03`</sub> | [**NIUS**](https://www.google.com/search?q=NIUS%20data%20breach&tbm=nws) &nbsp; <sub>`nius.de`</sub><br><sub>**6,090** accounts compromised</sub><br><sub>Data: `bank account numbers` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-08-23`</sub> |
| [**`CVE-2026-11586`**](https://nvd.nist.gov/vuln/detail/CVE-2026-11586) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>By default, curl automatically responds to WebSocket PING frames. Because curl
lacks an upper...</sub><br><sub>Published: `2026-07-03`</sub> | [**GolfCanada**](https://www.google.com/search?q=GolfCanada%20data%20breach&tbm=nws) &nbsp; <sub>`golfcanada.ca`</sub><br><sub>**568,972** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-08-22`</sub> |
<!-- SECURITY-END -->
---
