...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-13 11:20 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-46470`**](https://nvd.nist.gov/vuln/detail/CVE-2026-46470) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.0**<br><sub>An issue was discovered in GStreamer gst-plugins-good before 1.28.2. When parsing MP4 audio t...</sub><br><sub>Published: `2026-05-14`</sub> | [**GlendaleCommunityCollege**](https://www.google.com/search?q=GlendaleCommunityCollege%20data%20breach&tbm=nws) &nbsp; <sub>`glendale.edu`</sub><br><sub>**793,925** accounts compromised</sub><br><sub>Data: `academic records` `dates of birth` `email addresses` &nbsp;·&nbsp; Added: `2026-07-11`</sub> |
| [**`CVE-2026-46469`**](https://nvd.nist.gov/vuln/detail/CVE-2026-46469) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.0**<br><sub>An issue was discovered in GStreamer gst-plugins-good before 1.28.2. When parsing MP4 audio t...</sub><br><sub>Published: `2026-05-14`</sub> | [**MoodyBibleInstitute**](https://www.google.com/search?q=MoodyBibleInstitute%20data%20breach&tbm=nws) &nbsp; <sub>`moody.edu`</sub><br><sub>**2,303,416** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-07-03`</sub> |
| [**`CVE-2026-44542`**](https://nvd.nist.gov/vuln/detail/CVE-2026-44542) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.1**<br><sub>FileBrowser Quantum is a free, self-hosted, web-based file manager. Prior to 1.3.1-stable and...</sub><br><sub>Published: `2026-05-14`</sub> | [**Sysco**](https://www.google.com/search?q=Sysco%20data%20breach&tbm=nws) &nbsp; <sub>`sysco.com`</sub><br><sub>**2,691,852** accounts compromised</sub><br><sub>Data: `customer feedback` `email addresses` `employers` &nbsp;·&nbsp; Added: `2026-06-28`</sub> |
<!-- SECURITY-END -->
---
