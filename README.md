...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-09-22 13:18 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-66032`**](https://nvd.nist.gov/vuln/detail/CVE-2026-66032) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.8**<br><sub>libssh2 through 1.11.1, fixed in commit 5e47761, contains a double-free vulnerability in the ...</sub><br><sub>Published: `2026-07-24`</sub> | [**LimeLeads**](https://www.google.com/search?q=LimeLeads%20data%20breach&tbm=nws) &nbsp; <sub>`limeleads.com`</sub><br><sub>**17,838,396** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `geographic locations` &nbsp;·&nbsp; Added: `2026-09-22`</sub> |
| [**`CVE-2026-65711`**](https://nvd.nist.gov/vuln/detail/CVE-2026-65711) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.2**<br><sub>sysPass through version 3.2.11 contains an OS command injection vulnerability that allows aut...</sub><br><sub>Published: `2026-07-24`</sub> | [**BurgerKingRussia**](https://www.google.com/search?q=BurgerKingRussia%20data%20breach&tbm=nws) &nbsp; <sub>`burgerkingrus.ru`</sub><br><sub>**3,155,792** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-09-21`</sub> |
| [**`CVE-2026-65710`**](https://nvd.nist.gov/vuln/detail/CVE-2026-65710) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.1**<br><sub>sysPass through version 3.2.11 contains a missing authorization vulnerability that allows aut...</sub><br><sub>Published: `2026-07-24`</sub> | [**Chess2026**](https://www.google.com/search?q=Chess2026%20data%20breach&tbm=nws) &nbsp; <sub>`chess.com`</sub><br><sub>**4,653,212** accounts compromised</sub><br><sub>Data: `email addresses` `geographic locations` `names` &nbsp;·&nbsp; Added: `2026-09-13`</sub> |
<!-- SECURITY-END -->
---
