...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-15 08:35 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-24228`**](https://nvd.nist.gov/vuln/detail/CVE-2026-24228) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.8**<br><sub>NVIDIA NeMo Framework for Linux contains a vulnerability where an attacker may cause deserial...</sub><br><sub>Published: `2026-06-16`</sub> | [**RingCentral**](https://www.google.com/search?q=RingCentral%20data%20breach&tbm=nws) &nbsp; <sub>`ringcentral.com`</sub><br><sub>**1,596,490** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-13`</sub> |
| [**`CVE-2026-24155`**](https://nvd.nist.gov/vuln/detail/CVE-2026-24155) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.8**<br><sub>NVIDIA NeMo Framework for all platforms contains a code injection vulnerability. A successful...</sub><br><sub>Published: `2026-06-16`</sub> | [**Alcon**](https://www.google.com/search?q=Alcon%20data%20breach&tbm=nws) &nbsp; <sub>`alcon.com`</sub><br><sub>**218,395** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-09`</sub> |
| [**`CVE-2026-10649`**](https://nvd.nist.gov/vuln/detail/CVE-2026-10649) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.6**<br><sub>A flaw was found in Pacemaker. An unauthenticated remote attacker can exploit an integer over...</sub><br><sub>Published: `2026-06-16`</sub> | [**BrinksHome**](https://www.google.com/search?q=BrinksHome%20data%20breach&tbm=nws) &nbsp; <sub>`brinkshome.com`</sub><br><sub>**732,162** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `names` &nbsp;·&nbsp; Added: `2026-08-08`</sub> |
<!-- SECURITY-END -->
---
