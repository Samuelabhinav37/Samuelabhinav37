...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-19 09:57 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-47099`**](https://nvd.nist.gov/vuln/detail/CVE-2026-47099) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **6.1**<br><sub>TeleJSON prior to 6.0.0 contains a DOM-based cross-site scripting vulnerability in the parse(...</sub><br><sub>Published: `2026-05-20`</sub> | [**Fluke**](https://www.google.com/search?q=Fluke%20data%20breach&tbm=nws) &nbsp; <sub>`fluke.com`</sub><br><sub>**821,100** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-45444`**](https://nvd.nist.gov/vuln/detail/CVE-2026-45444) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **10.0**<br><sub>Unrestricted Upload of File with Dangerous Type vulnerability in WP Swings Gift Cards For Woo...</sub><br><sub>Published: `2026-05-20`</sub> | [**GooseCreek**](https://www.google.com/search?q=GooseCreek%20data%20breach&tbm=nws) &nbsp; <sub>`goosecreek.com`</sub><br><sub>**6,574,121** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-07-15`</sub> |
| [**`CVE-2026-39850`**](https://nvd.nist.gov/vuln/detail/CVE-2026-39850) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.4**<br><sub>Yii 2 is a PHP application framework. Versions 2.0.54 and prior contain flawed logic in the c...</sub><br><sub>Published: `2026-05-20`</sub> | [**GlendaleCommunityCollege**](https://www.google.com/search?q=GlendaleCommunityCollege%20data%20breach&tbm=nws) &nbsp; <sub>`glendale.edu`</sub><br><sub>**793,925** accounts compromised</sub><br><sub>Data: `academic records` `dates of birth` `email addresses` &nbsp;·&nbsp; Added: `2026-07-11`</sub> |
<!-- SECURITY-END -->
---
