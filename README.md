...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-07-12 09:57 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-42408`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42408) ![MEDIUM](https://img.shields.io/badge/MEDIUM-FFAA00?style=flat-square) **4.4**<br><sub>When BIG-IP DNS is provisioned, a vulnerability exists in an undisclosed TMOS Shell (tmsh) co...</sub><br><sub>Published: `2026-05-13`</sub> | [**GlendaleCommunityCollege**](https://www.google.com/search?q=GlendaleCommunityCollege%20data%20breach&tbm=nws) &nbsp; <sub>`glendale.edu`</sub><br><sub>**793,925** accounts compromised</sub><br><sub>Data: `academic records` `dates of birth` `email addresses` &nbsp;·&nbsp; Added: `2026-07-11`</sub> |
| [**`CVE-2026-42406`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42406) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **8.7**<br><sub>A vulnerability exists in BIG-IP and BIG-IQ systems where a highly privileged, authenticated ...</sub><br><sub>Published: `2026-05-13`</sub> | [**MoodyBibleInstitute**](https://www.google.com/search?q=MoodyBibleInstitute%20data%20breach&tbm=nws) &nbsp; <sub>`moody.edu`</sub><br><sub>**2,303,416** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-07-03`</sub> |
| [**`CVE-2026-42290`**](https://nvd.nist.gov/vuln/detail/CVE-2026-42290) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.8**<br><sub>protobufjs-cli is the command line add-on for protobuf.js. Prior to 1.2.1 and 2.0.2, pbts inv...</sub><br><sub>Published: `2026-05-13`</sub> | [**Sysco**](https://www.google.com/search?q=Sysco%20data%20breach&tbm=nws) &nbsp; <sub>`sysco.com`</sub><br><sub>**2,691,852** accounts compromised</sub><br><sub>Data: `customer feedback` `email addresses` `employers` &nbsp;·&nbsp; Added: `2026-06-28`</sub> |
<!-- SECURITY-END -->
---
