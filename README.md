...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-06-05 11:33 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-35039`**](https://nvd.nist.gov/vuln/detail/CVE-2026-35039) ![CRITICAL](https://img.shields.io/badge/CRITICAL-FF0000?style=flat-square) **9.1**<br><sub>fast-jwt provides fast JSON Web Token (JWT) implementation. From 0.0.1 to before 6.2.0, setti...</sub><br><sub>Published: `2026-04-06`</sub> | [**BCDTravel**](https://www.google.com/search?q=BCDTravel%20data%20breach&tbm=nws) &nbsp; <sub>`bcdtravel.com`</sub><br><sub>**396,313** accounts compromised</sub><br><sub>Data: `email addresses` `employers` `job titles` &nbsp;·&nbsp; Added: `2026-06-05`</sub> |
| [**`CVE-2026-35037`**](https://nvd.nist.gov/vuln/detail/CVE-2026-35037) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.2**<br><sub>Ech0 is an open-source, self-hosted publishing platform for personal idea sharing. Prior to 4...</sub><br><sub>Published: `2026-04-06`</sub> | [**DentaQuest**](https://www.google.com/search?q=DentaQuest%20data%20breach&tbm=nws) &nbsp; <sub>`dentaquest.com`</sub><br><sub>**2,553,599** accounts compromised</sub><br><sub>Data: `dates of birth` `email addresses` `genders` &nbsp;·&nbsp; Added: `2026-06-03`</sub> |
| [**`CVE-2026-35036`**](https://nvd.nist.gov/vuln/detail/CVE-2026-35036) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>Ech0 is an open-source, self-hosted publishing platform for personal idea sharing. Prior to 4...</sub><br><sub>Published: `2026-04-06`</sub> | [**Edmunds**](https://www.google.com/search?q=Edmunds%20data%20breach&tbm=nws) &nbsp; <sub>`edmunds.com`</sub><br><sub>**177,860** accounts compromised</sub><br><sub>Data: `device information` `email addresses` `ip addresses` &nbsp;·&nbsp; Added: `2026-06-01`</sub> |
<!-- SECURITY-END -->
---
