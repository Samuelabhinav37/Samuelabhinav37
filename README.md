...
<sub>Automated · NVD + HaveIBeenPwned · Last updated: 2026-08-21 08:48 UTC</sub>

| VULNERABILITY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | BREACH DISCLOSURE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
| :--- | :--- |
| [**`CVE-2026-53571`**](https://nvd.nist.gov/vuln/detail/CVE-2026-53571) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>Vite is a frontend tooling framework for JavaScript. Prior to 8.0.16, 7.3.5, and 6.4.3, the c...</sub><br><sub>Published: `2026-06-22`</sub> | [**OzHairAndBeauty**](https://www.google.com/search?q=OzHairAndBeauty%20data%20breach&tbm=nws) &nbsp; <sub>`ozhairandbeauty.com`</sub><br><sub>**1,988,331** accounts compromised</sub><br><sub>Data: `email addresses` `geographic locations` `names` &nbsp;·&nbsp; Added: `2026-08-19`</sub> |
| [**`CVE-2026-53540`**](https://nvd.nist.gov/vuln/detail/CVE-2026-53540) ![LOW](https://img.shields.io/badge/LOW-339900?style=flat-square) **3.7**<br><sub>Python-Multipart is a streaming multipart parser for Python. Prior to 0.0.31, parse_form() di...</sub><br><sub>Published: `2026-06-22`</sub> | [**Fanlore**](https://www.google.com/search?q=Fanlore%20data%20breach&tbm=nws) &nbsp; <sub>`fanlore.org`</sub><br><sub>**144,520** accounts compromised</sub><br><sub>Data: `email addresses` `names` `passwords` &nbsp;·&nbsp; Added: `2026-08-19`</sub> |
| [**`CVE-2026-53539`**](https://nvd.nist.gov/vuln/detail/CVE-2026-53539) ![HIGH](https://img.shields.io/badge/HIGH-FF6600?style=flat-square) **7.5**<br><sub>Python-Multipart is a streaming multipart parser for Python. Prior to 0.0.30, when parsing ap...</sub><br><sub>Published: `2026-06-22`</sub> | [**RingCentral**](https://www.google.com/search?q=RingCentral%20data%20breach&tbm=nws) &nbsp; <sub>`ringcentral.com`</sub><br><sub>**1,596,490** accounts compromised</sub><br><sub>Data: `email addresses` `names` `phone numbers` &nbsp;·&nbsp; Added: `2026-08-13`</sub> |
<!-- SECURITY-END -->
---
